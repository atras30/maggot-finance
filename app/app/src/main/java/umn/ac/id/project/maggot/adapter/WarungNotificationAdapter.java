...
public class WarungNotificationAdapter extends RecyclerView.Adapter<WarungNotificationAdapter.ListApprovalRejectionViewHolder> {
    Context context;
    private ArrayList<NotificationUserModel.Notification> notifications;
    public OnItemClickListener listener;

    public WarungNotificationAdapter(Context context, ArrayList<NotificationUserModel.Notification> notifications) {
